    ...
    >
      ...
      >
        ...
        <div className="flex justify-start flex-col mt-5">
          <div>
            <h2 className="text-s  font-bold  border-b border-gray-500 border-solid text-center  text-blue-500">
              Personal Dati
            </h2>
          </div>
          {/*Name and Lastname */}
        ...
        <div className="flex flex-col justify-start items-center">
          <h2 className="text-s  font-bold border-b border-gray-500 border-solid w-auto text-blue-500">Compotenza</h2>
        ...
        {/* Languages */}
        <div className="flex flex-col justify-start items-center">
          <h2 className="text-s  font-bold border-b border-gray-500 border-solid text-blue-500">Lingue</h2>
      ...
      <div className="flex flex-col mt-2 ml-2 mb-2 max-w-xs mt-5">
        ...
        {/* Profile */}
        <div className="mb-1">
          <h2 className="text-s  font-bold border-b border-gray-500 border-solid text-blue-500">Profile</h2>
          <p className="text-xs">
        ...
        {/* Istruzione */}
        <div className="mb-1">
          <h2 className="text-s font-bold border-b border-gray-500 border-solid text-blue-500">Istruzione</h2>
        ...
        {/* Experience */}
        <div className="mb-1">
          <h2 className="mb-1 text-s  font-bold border-b border-gray-500 border-solid text-blue-500 ">Experience</h2>
