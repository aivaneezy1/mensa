...
const CardTwoModel = (props) => {
  ...
  const { setCardTwoColor } = useContext(DatiContext);
  ...
  return (
    ...
    >
      ...
      >
        {/*BACK GROUND on top */}
        <div
          className="relative bg-third rounded-b-full flex  justify-center items-center h-40 w-60"
          style={{ backgroundColor: props.cardColors }}
        >
          <div className="absolute bottom-5 transform translate-y-1/2">
            {props.selectedImage && (
              <Image
