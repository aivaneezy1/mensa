...
const UserCardTwoZoomed = (props) => {
  const datiPersonaliZoomed = (image, dati, dati2, dati3, dati4) => {
    return (
      ...
      <>
        {data.map((post, index) => (
          <div key={index}>
            ...
            <p className="text-gray-500 text-xs break-words whitespace-normal text-center">{post.livello}</p>
          </div>
        ))}
      </>
    );
    ...
    return (
      <>
        {data.length > 0 &&
          data.map((post, index) => (
            <div key={index}>
              <p className="text-xs break-words font-bold  whitespace-normal mt-2">{post.data}</p>
          ...
          <div className="grid grid-cols-2  sm:p-2 max-w-screen-sm mx-auto shadow-md relative h-full">
            ...
            >
              ...
              <div className="flex flex-col justify-start items-center">
                ...
                {props.competenza.length > 0 && (
                  compAndLang(props.competenza)
                )}
              </div>
              ...
              <div className="flex flex-col justify-start items-center">
                ...
                {props.lingua.length > 0 && (
                  compAndLang(props.lingua)
                )}
              </div>
            </div>
...
export default UserCardTwoZoomed;
